...
global input "C:\Arti\\Raw Data\ASI2000_01"	
...
keep if slno <=5 | slno>=10 & slno<=17	;
tostring slno, replace	;
...
***no need for code below as value is anyway 0;
*ren  valueelectricitygenerated valueofelectricitygenerated;
...
replace electricitypurchased = quantityelectricityconsumed if electricitypurchased ==.;
replace valueelectricitypurchased = valueelectricityconsumed if int(valueelectricitypurchased  )!= int(valueelectricityconsumed );
...
************cleaning quantity electricity generated;
replace electricitygenerated = quantityelectricitygenerated if (electricitygenerated==. |electricitygenerated==0);
g elec_p = valueelectricitygenerated/electricitygenerated;
g elec_pq = valueelectricitygenerated/quantityelectricitygenerated; 
replace electricitygenerated = quantityelectricitygenerated if elec_p>7;
replace electricitygenerated = quantityelectricitygenerated if elec_p<2 & elec_pq>2 & elec_pq<9;

drop elec_* quantityelectricitygenerated ;

*******valueelecconsumed_imputed ;
egen valueofelectricityconsumed  = rsum(valueelectricitypurchased valueelectricitygenerated);
drop valueelectricityconsumed quantityelectricityconsumed; 

save "$intdata\ASI0001_clean1", replace;
